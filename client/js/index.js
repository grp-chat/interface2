...
t5 = new TaskCreate(green, "363", 5, "1x: 5s", "3 tries", "+ 8pts");
...
t13 = new TaskCreate(blue, "333", 13, "1x: 5s", "1 try", "+ 8pts");
t14 = new TaskCreate(pink, "333", 14, "1x: 3s", "3 tries", "+ 16pts");
t15 = new TaskCreate(purple, "333", 15, "4x: 17s", "1 try", "+ 17pts");
t16 = new TaskCreate(yellow, "333", 16, "1x: 3s", "1 try", "+ 20pts");
...
t30 = new TaskCreate(grey, "363", 30, "4x: 27s", "1 try", "+ 8pts");
t31 = new TaskCreate(blue, "363", 31, "4x: 21s", "1 try", "+ 19pts");
t32 = new TaskCreate(pink, "363", 32, "4x: 17", "Best of 2", "+ 23pts");
...
const Players = {
    P1: "H", P2: "SZF", P3: "JHA", P4: "JL", P5: "LXR", P6: "JV", P7: "LK", P8: "", P9: ""
};
